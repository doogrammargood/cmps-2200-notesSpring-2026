...
This document contains excerpts from the pocket_cube lab.
In this lab, I present the students with a simulation of a pocket cube and challenge them to solve it
